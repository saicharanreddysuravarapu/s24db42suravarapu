...
router.get('/', function (req, res) {
 res.render('index', { title: 'lighthouse App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'lighthouse App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'lighthouse App Login', user : req.user });
 });
